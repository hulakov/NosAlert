...
* ⚡ **Оперативність:** Опитування API кожні **10 секунд** (відповідає допустимому ліміту 8–10 запитів/хв).
* 🗺 **Мульти-регіональність:** Можливість обирати одну або декілька областей, районів чи громад для моніторингу через інтерфейс налаштування.
