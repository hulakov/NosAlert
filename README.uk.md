...
* 🗺 **Автоматичне створення сенсорів:** Для кожного обраного вами регіону, району або громади автоматично створюється набір сенсорів.
* 🔴🟡 **Колір тривоги:** Окремий сенсор чітко показує поточний рівень небезпеки (Червоний — тривога, Жовтий — часткова небезпека, Спокійно) з динамічними іконками безпеки.
* 📡 **Список загроз:** Сенсор активних загроз виводить зрозумілий текстовий перелік того, що саме летить (наприклад: "Шахеди/БпЛА", "Крилаті ракети", "Балістика").
* ⚡ **Оновлення в реальному часі:** Інтеграція постійно оновлює всі сенсори кожні **10 секунд**, забезпечуючи найшвидше отримання інформації без перевищення лімітів API (8–10 запитів/хв).
* 🌐 **Повна локалізація:** Підтримка української та англійської мов для всіх назв сутностей та станів.
* 🚨 **Легкі автоматизації:** Завдяки правильним класам пристроїв (`device_class`: Safety, Timestamp, Enum, Measurement), сенсори ідеально підходять для налаштування ваших власних сирен та сповіщень.
